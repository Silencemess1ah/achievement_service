...
public class AchievementController {
    ...
    public List<UserAchievementDto> getUserAchievementsByUserId(@RequestHeader("x-user-id")
                                                                @NotNull(message = "x-user-id cannot be null")
                                                                @NotBlank(message = "x-user-id cannot be empty")
                                                                String userId) {
    ...
    public List<AchievementProgressDto> getInProgressUserAchievementsByUserId(@RequestHeader("x-user-id")
                                                                              @NotNull(message = "x-user-id cannot be null")
                                                                              @NotBlank(message = "x-user-id cannot be empty")
                                                                              String userId) {
