...
VALUES ('COLLECTOR', 'For 100 goals', 3, 15, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
INSERT INTO user_achievement_progress (user_id, achievement_id, current_points, version, created_at, updated_at)
VALUES (1, 3, 7, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);